...
function IntLayer:initialize(data, layerDefinition, level, tilesets)
    ...
    for _, gridValue in ipairs(layerDefinition.intGridValues) do
    ...
    if data.autoLayerTiles and #data.autoLayerTiles > 0 then
        self.tileLayer = TileLayer:new(data, layerDefinition, level, tilesets)
    end
end
